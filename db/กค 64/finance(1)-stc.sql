...
CREATE TABLE `bankevent` (
  ...
  PRIMARY KEY  (`num`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4631 ;

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `bankmember`
-- 
...
-- 
-- โครงสร้างตาราง `copy of deposit`
-- 
...
CREATE TABLE `deposit` (
  ...
  `DepositStatus` char(1) NOT NULL default 'P',
  PRIMARY KEY  (`IDDeposit`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=396099 ;

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `depositless`
-- 
...
-- 
-- โครงสร้างตาราง `depositstatement`
-- 
...
CREATE TABLE `deposit_n` (
  ...
  PRIMARY KEY  (`IDDeposit`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10549 ;

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `dep_member`
-- 
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=45145 ;

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `loanpaymentlastdate`
-- 
...
-- 
-- โครงสร้างตาราง `loanpaymentless`
-- 
...
-- 
-- โครงสร้างตาราง `loantransaction`
-- 
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=72777 ;

-- --------------------------------------------------------

-- 
-- โครงสร้างตาราง `loan_order`
-- 
...
-- 
-- โครงสร้างตาราง `logdeposit`
-- 

CREATE TABLE `logdeposit` (
  `LogIDDeposit` int(9) NOT NULL auto_increment,
  `IDDeposit` varchar(10) NOT NULL default '',
  `IDRegFund` varchar(10) NOT NULL default '',
  `Username` varchar(10) NOT NULL default '',
  `CreateDate` date default NULL,
  `LastUpdate` date default NULL,
...
-- 
-- โครงสร้างตาราง `paymentfriendfund`
-- 
